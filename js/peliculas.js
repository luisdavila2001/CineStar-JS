...
const getPeliculas = async () => {
	...
	const data = await fetch(`https://webcinestar001.000webhostapp.com/cinestar_sweb_php/peliculas/${idx}`) //con 00webhost


	//const data = await fetch(`http://localhost/cinestar_sweb_php/peliculas/cartelera`) //con localhost
